...
//added by vtpp for host in blacklist and whitelist...
#define CHAIN_HOSTWHITELIST "WiFiDog_$ID$_HostWhitelist"
#define CHAIN_HOSTBLACKLIST "WiFiDog_$ID$_HostBlacklist"
...
/** @brief add rules to iptables chain,briefly in filter and nat table*/
int iptables_create_chain(char *ruleset,char *chain);

/** @brief demonish rules in iptables chain,briefly in filter and nat table*/
